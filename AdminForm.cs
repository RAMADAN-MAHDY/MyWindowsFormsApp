...
private void addButton_Click(object? sender, EventArgs e)
{
    ...
    if (tableCount > 0)
    {
        MessageBox.Show("Table already exists. Please enter a different table number.");
        return;
    }
...
private void deleteButton_Click(object? sender, EventArgs e)
{
    ...
    if (isReserved)
    {
        MessageBox.Show("The table is reserved. Please cancel the reservation first.");
        return;
    }
...
private void CancelReservation(int reservationId)
{
    ...
    {
        MessageBox.Show($"Error while cancelling the reservation: {ex.Message}");
    }
}
...
private void RefreshReservations()
{
    ...
    {
        MessageBox.Show($"Error refreshing reservations: {ex.Message}");
    }
}
 ...
 private void InitializeComponent()
{
    ...
    this.editButton.Text = "Edit Table";
    ...
    this.viewReservedButton.Text = "View Reserved";
